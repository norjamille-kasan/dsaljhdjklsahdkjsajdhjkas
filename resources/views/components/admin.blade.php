    ...
    -->
      ...
      -->
        ...
        -->
                    ...
                    <div class="flex flex-col px-6 pb-4 overflow-y-auto bg-indigo-600 grow gap-y-5">
                        <div class="flex items-center h-16 shrink-0">
                            <img class="w-auto h-8" src="https://tailwindui.com/img/logos/mark.svg?color=white"
                                alt="Your Company">
                        </div>
                            ...
                            <ul role="list" class="flex flex-col flex-1 gap-y-7">
                                <li>
                                    <ul role="list" class="-mx-2 space-y-1">
                                        ...
                                        <li>
                                            <a href="#"
                                                class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
                                                <svg class="w-6 h-6 text-indigo-200 shrink-0 group-hover:text-white"
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <!-- Sidebar component, swap this element with another sidebar if you like -->
            <div class="flex flex-col px-6 pb-4 overflow-y-auto bg-indigo-600 grow gap-y-4">
                <div class="flex items-center h-16 shrink-0">
                    <div class="border w-full p-3 mt-5 rounded-lg">
                    ...
                    <ul role="list" class="flex flex-col flex-1 gap-y-7">
                        <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('admin.role-and-permissions') }}"
                                        class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor"
                                            class="w-6 h-6 text-indigo-200 shrink-0 group-hover:text-white">
                ...
                <div class="flex self-stretch flex-1 gap-x-4 lg:gap-x-6">
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div x-data="{ show: false }" class="relative">
                            <button x-on:click="show=!show" x-on:click.away="show=false" type="button"
                                class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false"
                                aria-haspopup="true">
                                <span class="sr-only">Open user menu</span>
                                <img class="w-8 h-8 rounded-full bg-gray-50"
                                    src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&background=4f46e5&color=ffffff"
                                    alt="">
                                <span class="hidden lg:flex lg:items-center">
                                    ...
                                    <svg x-bind:class="{
                                        ...
                                        class="w-5 h-5 ml-2 text-gray-400" viewBox="0 0 20 20" fill="currentColor"
                                        aria-hidden="true">
                            ...
                            <div x-cloak x-show="show" x-transition:enter="transition ease-out duration-100"
                                ...
                                tabindex="-1">
                                <a href="/admin/account-setting" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-1">Account Setting</a>
