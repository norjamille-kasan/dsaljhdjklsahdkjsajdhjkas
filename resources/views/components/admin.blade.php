        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="flex items-baseline ml-10 space-x-4">
              <a href="/admin/dashboard" class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-500 hover:bg-opacity-75">Dashboard</a>

              <a href="/admin/users" class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-500 hover:bg-opacity-75">Manage Users</a>
              <a href="/admin/companies" class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-500 hover:bg-opacity-75">Manage Companies</a>
              <a href="/admin/submission" class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-500 hover:bg-opacity-75">Submissions</a>

              <a href="#" class="px-3 py-2 text-sm font-medium text-white rounded-md hover:bg-indigo-500 hover:bg-opacity-75">Reports</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
