      ...
      <nav class="flex flex-col flex-1">
        <ul role="list" class="flex flex-col flex-1 gap-y-7">
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                <a href="{{ route('admin.dashboard') }}" class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
              ...
              <li>
                <a href="{{ route('admin.companies') }}" class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-indigo-200 shrink-0 group-hover:text-white">
              ...
              <li>
                <a href="{{ route('admin.submission') }}" class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  class="w-6 h-6 text-indigo-200 shrink-0 group-hover:text-white">
              ...
              <li>
                <a href="{{ route('admin.users') }}" class="flex p-2 text-sm font-semibold leading-6 text-indigo-200 rounded-md hover:text-white hover:bg-indigo-700 group gap-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-indigo-200 shrink-0 group-hover:text-white">
        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <div  x-data="{show:false}" class="relative">
            <button x-on:click="show=!show" x-on:click.away="show=false" type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
              ...
              <img class="w-8 h-8 rounded-full bg-gray-50" src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&background=4f46e5&color=ffffff" alt="">
              <span class="hidden lg:flex lg:items-center">
                ...
                class="w-5 h-5 ml-2 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            class="absolute right-0 z-10 mt-2.5 w-48 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
