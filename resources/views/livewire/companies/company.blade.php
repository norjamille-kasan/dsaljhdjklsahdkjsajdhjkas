                                                                                    ...
                                                                                    @forelse ($task->questions as $key=>$question)
                                                                                        <li x-data="{ showSelection: false }"
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                class="text-sm text-yellow-600 underline">Edit</button>
                                                                                            @if ($question->selectable)
                                                                                                <button
                                                                                                    x-on:click="showSelection=!showSelection">
                                                                                                    <svg x-bind:class="{
                                                                                            ...
                                                                                            @if ($question->selectable)
                                                                                                ...
                                                                                                @endphp
                                                                                                <div x-show="showSelection"
                                                                                                    x-collapse.duration.500>
                                                                                                    <ul class="px-5">
                                                                                                        @foreach ($options as $option)
                                                                                                            <li
                                                                                                                wire:key="sq-{{ $key . $question->id }}-selection">
                                                                                                                -
                                                                                                                {{ $option }}
                                                                                                            </li>
                                                                                                        @endforeach
